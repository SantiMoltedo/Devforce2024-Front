  ...
  return (
    <div className="sidebar fixed top-0 left-0 w-20 flex flex-col items-center h-full bg-dfGrey py-8">
      ...
      <div className="userIcons">
        ...
        <SidebarIcon tooltip={"Mis cursos"} icon={<FaBookReader size={28} />} />
        <SidebarIcon
        ...
        />
        {/* CONDICION DE USUAR"IO / MENTOR / ADMIN */}
        <SidebarIcon tooltip={"Solicitudes"} icon={<FaInbox size={28} />} />
        <SidebarIcon tooltip={"Estadisticas"} icon={<FaChartBar size={28} />} />
        <SidebarIcon tooltip={"Licencias"} icon={<FaFolder size={28} />} />
      </div>
      <SidebarIcon
        className="mt-auto"
        tooltip={"Ajustes"}
